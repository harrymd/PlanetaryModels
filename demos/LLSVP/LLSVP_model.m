function [] = LLSVP_model(mod_path, mod_path_ref, pOrder, nlayer, at, MI, RD, make_vtk)
    ...
    % x, y, z [10, nele] CCoordinates of each node.
    [x,y,z,tet] = construct(fname,pOrder);

    [vp0, vs0, rho0]                = assign_params_to_nodes(pNp, nlayer,   ...
                                        x, y, z,                            ...
    ...
    [vp0_ref, vs0_ref, rho0_ref]    = assign_params_to_nodes(pNp, nlayer,   ...
                                        x, y, z,                            ...
                                        at, MI, RD, r_max_llsvp,        	...
                                        NaN, NaN,                       	...
                                        NaN, NaN,                        	...
...
%         in_llsvp_rad    = ((rvd >= R2) & (rvd <= r_max_llsvp));
%         
